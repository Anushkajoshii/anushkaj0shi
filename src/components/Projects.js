        ...
        {showML && (
          <>
            ...
            <div className="project">
              ...
              <p>Classifies SMS messages as spam or ham using NLP techniques.</p>
              <p><strong>Tech Stack:</strong> Python, Scikit-Learn, NLTK, Pandas</p>
            </div>
            ...
            <div className="project">
              ...
              <p>Explore my Kaggle notebooks for various data science projects and analysis.</p>
                <ul>
                  ...
                  <li>
                    <a href="https://www.kaggle.com/code/anushkajoshii/restaurant-s-cuisine-rating-eda">
