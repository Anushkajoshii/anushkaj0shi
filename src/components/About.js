...
const About = React.forwardRef((props, ref) => {
  return (
    <section ref={ref} id="about" className="about-container">
      ...
      <div className="about-content">
        <p>
          Hi, I'm Anushka Joshi, a dedicated learner pursuing a B.Tech in Computer Science and Engineering with a specialization in AI and ML from Vellore Institute of Technology, Bhopal. I have earned certifications including AWS Cloud Practitioner, Applied Machine Learning by the University of Michigan, and VITYarthi Computer Vision certification. These achievements, combined with my passion for problem-solving, have equipped me with the skills to build impactful solutions.
        </p>
        <p>
          I am a passionate MERN stack web developer and machine learning enthusiast with hands-on experience in projects like customer churn prediction, gesture recognition, and conversational AI systems. I enjoy tackling complex problems using technologies such as React, Node.js, Scikit-learn, TensorFlow, and PyTorch.
        </p>
        <p>
          As an active participant in Kaggle competitions and a regular technical blogger on Medium, I am committed to continuous learning and knowledge sharing. I also contribute to open-source projects, enhancing collaboration and community impact.
        </p>
        <p>
          Outside of work, I express myself through dance and love exploring new places through travel. These hobbies keep me inspired and balanced in my journey as a lifelong learner.
        </p>
      </div>
      ...
      <div className="about-certifications">
        ...
        <div className="certification-item">
          ...
          <p>
            Earned the AWS Cloud Practitioner certification, which validates foundational cloud knowledge and skills. You can view my certification{" "}
            <a
        ...
        <div className="certification-item">
          ...
          <p>
            Completed the Applied Machine Learning certification by the University of Michigan, focusing on practical machine learning techniques. You can view my certification{" "}
            <a
              href="https://www.coursera.org/account/accomplishments/verify/HVA6O4FI9KB7"
              target="_blank"
              rel="noopener noreferrer"
            >
              here
      ...
      <div className="certification-item">
        <h3>Machine Learning with Python by IBM</h3>
        <p>
          Completed the Machine Learning with Python course by IBM on Coursera. You can view my certification{" "}
          <a
            href="https://www.coursera.org/account/accomplishments/verify/HVA6O4FI9KB7"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <div className="certification-item">
          <h3>VITYarthi Computer Vision Certification</h3>
          <p>
            Completed the Computer Vision certification by VITYarthi. You can view my certification{" "}
            <a
              href="https://drive.google.com/file/d/1pssr_uy4NHhXHwUCyMvWtaqh3ZrWxlvQ/view?usp=sharing"
              target="_blank"
              rel="noopener noreferrer"
            >
              here
      ...
      <div className="about-skills">
        ...
        <div className="skills-list">
          ...
          <div className="skill-item">
            ...
            <p>Experienced with Scikit-learn, TensorFlow, PyTorch, OpenCV, MediaPipe, and deep learning frameworks. Passionate about solving problems with machine learning and AI.</p>
          </div>
          <div className="skill-item">
